...
const Response=()=>{
   return <div className=" flex flex-col justify-center items-center text-white space-y-5  bg-black p-10 min-h-[100vh] ">
             ...
             <div className="p-10 rounded-2xl border-2 ">
               ...
               <p>a mail will be sent to your email adress for futher information</p>
             </div>
          </div>
        }
